...
When reporting security issues, do not include private videos, secrets, credentials, or unredacted personal data.

Share a minimal reproduction that does not expose sensitive material.
