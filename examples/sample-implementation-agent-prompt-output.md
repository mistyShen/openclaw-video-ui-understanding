...
- Treat exact primary action copy, payment fields, and success headline as TODO items because they are `unable to confirm`.
...
- Unclear details: exact primary action copy, payment fields, success headline.
```
